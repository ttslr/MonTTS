...
"""Perform preprocessing and raw feature extraction for Mongolian dataset."""
...
class monProcessor(BaseProcessor):
    ...
    train_f_name: str = "32597_metadata.csv"
    ...
    def split_line(self, data_dir, line, split):
        ...
        wav_path = os.path.join(data_dir, "32597_wavs", f"{wave_file}.wav")
        speaker_name = "mon"
